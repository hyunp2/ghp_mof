...
# https://github.com/ehoogeboom/e3_diffusion_for_molecules/blob/fce07d701a2d2340f3522df588832c2c0f7e044a/qm9/models.py#L101
...
class DistributionProperty:
    def __init__(self, dataloader, properties, num_bins=1000, normalizer=None):
        ...
        for prop in properties:
            ...
            self._create_prob_dist(dataloader.dataset.data['num_atoms'],
                                   dataloader.dataset.data[prop],         ###ADD REWARD CONDITION HERE!!!
                                   self.distributions[prop])
    ...
    def sample_batch(self, nodesxsample: List[int]):
        vals = []
